...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { code_id: @code.code_id, code_value: @code.code_value, owner: @code.owner, title: @code.title } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { code_id: @code.code_id, code_value: @code.code_value, owner: @code.owner, title: @code.title } }
